...
According to the American Academy of Pediatrics (AAP), teens and adults should be limited to two hours of daily entertainment (PUT CITATION HERE). That means the threshold of 15 hours/ week can be considered as normal limit of online streaming and gaming.
...
predicted_classes_optimal <- ifelse(predicted_probabilities > optimal_cutoff, 1, 0)
