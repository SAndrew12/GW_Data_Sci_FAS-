...
ggplot(residuals_df, aes(Var1, Var2, fill = value)) +
  ...
  labs(title = "GAD and WhyPlay Adjusted Residuals Heatmap", x = "GAD", y = "whyplay") +
  theme_minimal()+
  theme(plot.title = element_text(hjust = 0.5))
...
ggplot(residuals_df, aes(Var1, Var2, fill = value)) +
  geom_tile() +
  scale_fill_gradient2(low = "blue", mid = "white", high = "red", midpoint = 0) +
  labs(title = "SPIN and WhyPlay Adjusted Residuals Heatmap", x = "SPIN", y = "whyplay") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
...
ggplot(residuals_df, aes(Var1, Var2, fill = value)) +
  geom_tile() +
  scale_fill_gradient2(low = "blue", mid = "white", high = "red", midpoint = 0) +
  labs(title = "SWL and WhyPlay Adjusted Residuals Heatmap", x = "SWL", y = "whyplay") +
  theme_minimal() +
  theme(
