...
Hours spent playing video games and hours spent streaming: there is no significant difference across all ordinal categories. GAD and hours played: a person is more likely to experience symptoms of generalized anxiety if the hours they spend playing video games is anywhere from low to moderate, low to high, or moderate to high. SWL and hours played:  satisfaction with life is significantly affected if video games are played within the low to moderate range. SPIN and hours played: a person is more likely to experience social anxiety or phobias if they play video games anywhere within the low to moderate range. For all the inventories, along with GADE, and the reason for playing video games, there is some level of dependency among them. ANOVA test for Total time spent and GAD_ordinal variables: People with different levels of GAD actually spend significantly different amounts of time on gaming and streaming.


## Recommendations 

To improve on our current work and findings, we could apply regression techniques, linear or logistic, to predict outcomes of time spent playing or streaming video games based on the current psychological inventories we have analyzed at length.
