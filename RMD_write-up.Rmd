...
df <- read.csv("G:\\My Drive\\Flash Drive Contents\\E\\Graduate School\\The George Washington Univeristy\\Data Science\\DATS 6101_12 (Morris)\\Project 1\\GamingStudy_data.csv")
```
...
## Hypothesis Tests (ANOVA and Chi-Squared)
...
To improve on our current work and findings, we could apply regression techniques, linear or logisitic, to predict outcomes of time spent playing or streaming video games based on the current pshychological inventories we have analyzed at length.
