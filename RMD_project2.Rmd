...
model_rf_100 <- randomForest(GAD_ord ~ cleaned_whyplay + hrs_stream_combined +Gender + Age + Game,
                             data = df, 
                             ntree = 100)

model_rf_200 <- randomForest(GAD_ord ~ cleaned_whyplay + hrs_stream_combined +Gender + Age + Game,
                             data = df, 
                             ntree = 200)

model_rf_500 <- randomForest(GAD_ord ~ cleaned_whyplay + hrs_stream_combined +Gender + Age + Game,
                             data = df, 
                             ntree = 500)

model_rf_1000 <- randomForest(GAD_ord ~ cleaned_whyplay + hrs_stream_combined +Gender + Age + Game,
                             data = df, 
                             ntree = 1000)

# Print out accuracy for each model
cat("Accuracy with 100 trees: ", mean(predict(model_rf_100) == df$GAD_ord), "\n")
cat("Accuracy with 200 trees: ", mean(predict(model_rf_200) == df$GAD_ord), "\n")
cat("Accuracy with 500 trees: ", mean(predict(model_rf_500) == df$GAD_ord), "\n")
cat("Accuracy with 1000 trees: ", mean(predict(model_rf_1000) == df$GAD_ord), "\n")
