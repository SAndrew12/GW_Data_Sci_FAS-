...
hist(gaming_data$hrs_stream_combined, main = "Histogram of total time Spent watching Steams, Tournaments, etc. (hrs/week)
", xlab = "Total time Spent watching Steams, Tournaments, etc. (hrs/week)
 ", col = "lightblue")
boxplot(gaming_data_clean$streams, main = "Boxplot of total time Spent watching Steams, Tournaments, etc. (hrs/week)", xlab = "Total time Spent watching Steams, Tournaments, etc. (hrs/week)", col = "lightblue")
```
